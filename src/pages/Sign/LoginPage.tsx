import {
  ...
  export default function LoginPage() {
    ...
    const handleChangeLogin = (event: IonInputCustomEvent<InputChangeEventDetail>) => {
      const { name, value}: HTMLIonInputElement = event.target
      setHandleLogin({...handleLogin, [name]: value})
    };
  
    const handleChangeSignUp = (event: IonInputCustomEvent<InputChangeEventDetail>) => {
      const { name, value}: HTMLIonInputElement = event.target
          ...
          {selectedSegment === "favorites" && (
            <div className="center-form">
              <form onSubmit={handleSubmitSignUp}>
                ...
                <IonCheckbox className="checkbox" labelPlacement="end">Accepter les termes et conditions d'utilisations</IonCheckbox>
  
                <IonButton className="custom-button" routerLink="/tabs/home">S'inscrire</IonButton>
          ...
          {selectedSegment === "all" && (
            <div className="center-form">
              <form onSubmit={handleSubmitLogin}>
                ...
                <IonButton className="custom-button" routerLink="/tabs/home">Se connecter</IonButton>
